...
function RekapitulasiLunas() {
  ...
  const { dataLunas } = useRekapStore((state) => state);
  ...
  const totalData = dataLunas.reduce(function (acc, obj) {
...
export default RekapitulasiLunas;
